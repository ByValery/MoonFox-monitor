(function(){
  const pairs = [
    ...
    ['Уведомления Telegram','Telegram notifications'],['Введите токен бота','Enter bot token'],['Введите chat ID','Enter chat ID'],
    ...
    ['Сбросить тексты Telegram к стандартным?','Reset Telegram messages to their defaults?'],['Тестовое сообщение отправлено в Telegram.','The test message was sent to Telegram.'],
